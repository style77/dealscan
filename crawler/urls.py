...
urlpatterns = [
    ...
    path("dashboard/offers/", subscription_required(offers_view), name="dashboard_offers"),
    path("dashboard/offers/all/", subscription_required(all_offers_view), name="dashboard_all_offers"),
